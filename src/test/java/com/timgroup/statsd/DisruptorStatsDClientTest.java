...
public class DisruptorStatsDClientTest {

    private static final int STATSD_SERVER_PORT = 17254;
    private static final DisruptorStatsDClient client = new DisruptorStatsDClient("my.prefix", "localhost", STATSD_SERVER_PORT);
    ...
    sends_counter_value_to_statsd_with_null_tags() throws Exception {
        ...
        client.count("mycount", 24, (String[]) null);
        server.waitForMessage();
